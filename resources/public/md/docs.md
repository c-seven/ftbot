...
Two middleware functions are provided by default in the `ftbot.middleware` namespace.
...
See the `:middleware` key of the `app` definition located in the `ftbot.handler` namespace to manage the enabled middleware.
